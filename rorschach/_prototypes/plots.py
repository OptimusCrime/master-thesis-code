...
class PlotCallback():
    ...
    def __init__(self):
        ...
        self.data_epoch = {
            'loss': [0, 301, 244, 231, 210],
            'val_loss': [0, 343, 333, 299, 211],
            'acc': [0, 0.11, 0.12, 0.09, 0.11],
            'val_acc': [0, 0.05, 0.22, 0.32, 0.26]
        }

        self.data_batch = {
            'loss': [301, 244, 231, 210],
            'val_loss': [343, 333, 299, 211],
            'acc': [0.11, 0.12, 0.09, 0.11],
            'val_acc': [0.05, 0.22, 0.32, 0.26]
        }
    ...
    def save_plot(self, fig, type):
        ...
        fig.savefig(Filesystem.get_root_path('data/test_' + file_name + '.png'))
