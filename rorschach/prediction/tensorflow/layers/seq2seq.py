...
class Seq2Seq(object):
    ...
    def build_graph(self):
        ...
        stacked_lstm = tf.nn.rnn_cell.MultiRNNCell([basic_cell] * self.num_layers, state_is_tuple=True)
        ...
        self.train_op = tf.train.AdamOptimizer(learning_rate=Config.get('predicting.learning-rate')).minimize(self.loss)
    ...
    def train(self, train_set, valid_set, sess=None):
        ...
        for i in range(Config.get('predicting.epochs')):
            print('Epoch', i)
            try:
