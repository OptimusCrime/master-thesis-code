...
class SignatureGenerator:
    ...
    def calculate_signature_sizes():
        ...
        img = Image.open(Filesystem.get_root_path() + '/dump/letters/' +
                         SignatureGenerator.LETTER_SET[0] + '.png')
    ...
    def concatenate_images():
        ...
        for letter in SignatureGenerator.LETTER_SET:
            letter_image = Image.open(Filesystem.get_root_path() + '/dump/letters/' +
                                      letter + '.png')
    ...
    def create_signature(image, signature_position=0, signature_height=1):
        ...
        signature_image.save(Filesystem.get_root_path() + '/dump/signatures/' +
                             str(signature_position) + '.png')
